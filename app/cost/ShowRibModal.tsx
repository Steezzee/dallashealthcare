...
interface setShowRibModalProp{
    onClose: () => void;
};
//main report pop up
export default function ShowRibModal({onClose}: setShowRibModalProp){
    return(
    // background/homepage
...
{/*Main title*/}
                <h1 className="text-2xl font-bold text-center">ESTIMATED COST FOR RIB PROCEDURE</h1>
...
<h2 className="text-xl font-semibold mb-3">Insurance Plan Details</h2>
             <div className="space-y-2">
              <div className="flex justify-between">Annual Deductible:<span>$1,500</span></div>
              ...
              <div className="flex justify-between">ER Copay:<span>$330</span></div>
              <div className="flex justify-between">Annual Out-of-pocket Max:<span>$3,550</span></div>
            </div>
</section>
...
<section>
 <h2 className="text-xl font-semibold">ER-Copay</h2>
            ...
            <div className="flex justify-between mb-2">
              Remaining Bill:<span>$2,700</span>
            </div>
</section>
...
<h2 className="text-xl font-semibold mb-3">Total Out-of-Pocket Cost</h2>
            <div className="space-y-2">
              <div className="flex justify-between">Copay:<span>$150</span></div>
              <div className="flex justify-between">Deductible:<span>$1,500</span></div>
              <div className="flex justify-between">Coinsurance:<span>$240</span></div>
