...
interface setShowArmModalProp{
    onClose: () => void;
};
//main report pop up
export default function ShowArmModal({onClose}: setShowArmModalProp){
    return(
    // background/homepage
...
{/*Main title*/}
                <h1 className="text-2xl font-bold text-center">ESTIMATED COST FOR ARM PROCEDURE</h1>
